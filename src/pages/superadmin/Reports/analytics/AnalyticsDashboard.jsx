...
// KPI cards, cards, tables and pills now live in ./ui so the Marketing Reports
// page renders from the exact same atoms. The role-specific pieces below
// (leaderboard list, funnel bars, hourly heatmap) stay local to this dashboard.
