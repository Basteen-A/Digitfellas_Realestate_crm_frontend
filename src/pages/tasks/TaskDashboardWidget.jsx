...
/**
 * Compact Task Management panel embedded inside a role portal's own dashboard.
 * Shows the same stats + recent activity as the standalone Task portal dashboard,
 * but routes "View all" back into the host portal's embedded Tasks screen via
 * `onOpenTasks` instead of navigating away to the standalone /task-portal.
 */
    ...
    <section className="tm-page" style={{ marginTop: 24 }}>
      <div className="tm-card">
        ...
        <div style={{ marginTop: 16 }}>
          <div className="tm-card__title" style={{ marginBottom: 8 }}>RECENT ACTIVITY</div>
