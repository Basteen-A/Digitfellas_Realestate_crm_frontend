...
const MODULE_LINKS = {
  ...
  projects: { section: 'INVENTORY', items: [
  ...
  payment_verification: { section: 'FINANCE', items: [
    { label: 'Verify Payments', path: '/accounts/verify', icon: MagnifyingGlassIcon },
  ] },

  automation: { section: 'AUTOMATION', items: [
  ...
  telephony: { section: 'TELEPHONY', items: [
