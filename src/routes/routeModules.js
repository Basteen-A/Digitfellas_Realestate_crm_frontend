...
const ROUTE_MODULES = [
  ...
  ['/super-admin/lead-types', 'masters', 'write'],
  ['/super-admin/lead-sources', 'masters', 'write'],
  ['/super-admin/lead-sub-sources', 'masters', 'write'],
  ['/super-admin/lead-stages', 'masters', 'write'],
  ['/super-admin/lead-statuses', 'masters', 'write'],
  ['/super-admin/status-remarks', 'masters', 'write'],
  ['/super-admin/motivations', 'masters', 'write'],
  ['/super-admin/closed-lost-reasons', 'masters', 'write'],
  ['/super-admin/score-master', 'masters', 'write'],
  ['/super-admin/booking-statuses', 'masters', 'write'],
  ['/super-admin/booking-cancel-reasons', 'masters', 'write'],
  ['/super-admin/payment-types', 'masters', 'write'],
  ['/super-admin/payment-plans', 'masters', 'write'],
  ['/super-admin/payment-modes', 'masters', 'write'],
  ['/super-admin/payment-statuses', 'masters', 'write'],
  ['/super-admin/banks', 'masters', 'write'],
  ['/super-admin/customer-types', 'masters', 'write'],
  ['/super-admin/terms-and-conditions', 'masters', 'write'],
];
